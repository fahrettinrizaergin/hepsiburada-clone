  ...
  <header class="flex flex-col space-y-3">
    <div class="topLinks container">
      <ul class="flex justify-end items-end gap-3 h-7">
        <li v-for="navItem in topNavbar" :key="navItem" class="h-5 text-xs">
  ...
  data () {
    return {
      ...
      navbar: [
        ...
        { label: 'Hepsiburada\'da Satıcı Ol', path: '#' },
        {
          label: 'Hepsiburada\'da Satıcı Ol',
          path: '#',
          children: [
            { label: 'Elekronik 1', path: '#' },
            { label: 'Elekronik 2', path: '#' },
            { label: 'Elekronik 3', path: '#' }
          ]
        }
      ]
    }
